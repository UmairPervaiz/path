...
<head>
    ...
    <title>Path Admin Panel - Login Page</title>

    <!-- Bootstrap framework -->
    <link rel="stylesheet" href="{{asset('public/admin/bootstrap/css/bootstrap.min.css')}}" />
    <!-- theme color-->
    <link rel="stylesheet" href="{{asset('public/admin/css/blue.css')}}" />
    <!-- tooltip -->
    <link rel="stylesheet" href="{{asset('public/admin/lib/qtip2/jquery.qtip.min.css')}}" />
    <!-- main styles -->
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('public/admin/js/ie/html5.js')}}"></script>
    <script src="{{asset('public/admin/js/ie/respond.min.js')}}"></script>
    <![endif]-->
...
<div class="login_box">
    ...
    <form action="{{ route('login') }}" method="post" id="login_form">
        @csrf
        <div class="top_b">Sign in to Path Admin</div>
        <div class="cnt_b">
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon input-sm"><i class="glyphicon glyphicon-user"></i></span>
                    <input class="form-control input-sm" type="email" id="email" name="email" placeholder="Email" value="" />
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
...
<script src="{{asset('public/admin/js/jquery.actual.min.js')}}"></script>
<script src="{{asset('public/admin/lib/validation/jquery.validate.js')}}"></script>
