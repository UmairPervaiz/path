...
<!-- tooltips -->
<script src="{{asset('admin/lib/qtip2/jquery.qtip.min.js')}}"></script>
<!-- lightbox -->
...
<!-- common functions -->
<script src="{{asset('admin/js/gebo_common.js')}}"></script>
...
<!-- dashboard functions -->
<script src="{{asset('admin/js/gebo_dashboard.js')}}"></script>
