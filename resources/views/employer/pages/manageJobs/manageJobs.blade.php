                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column mr-auto">
                                        <!--begin: Title-->
                                        <div class="d-flex flex-column mr-auto">
                                            <a href="{{route('viewJob', encrypt($job->id))}}" class="text-dark text-hover-primary font-size-h4 font-weight-bolder mb-1">{{$job->title}}</a>
                            ...
                            <div class="card-footer d-flex align-items-center">
                                <div class="d-flex">
                                    <div class="d-flex align-items-center mr-7">
                                        ...
                                        <a href="{{route('manageCandidates', encrypt($job->id))}}" class="font-weight-bolder text-primary ml-2">{{count($totalApplications)}} Application(s)</a>
                                    </div>
                                    <div class="d-flex align-items-center mr-7">
                                            <span class="svg-icon svg-icon-gray-500">
                                        ...
                                        <a href="#" class="font-weight-bolder text-primary ml-2">@if($job->status == 1) Active @else Inactive @endif</a>
                                    </div>
                                </div>
                            </div>
                            <!--end::Footer-->
