        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Update Job</h5>
                </div>
            </div>
        </div>
                        ...
                        <div class="card card-custom card-stretch">
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    <h3 class="card-label font-weight-bolder text-dark">Update Job Details</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  placeholder="Enter" name="title" value="{{$job->title}}" required/>
                                                @error('title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="salary" class="form-control" required>
                                                    ...
                                                    @foreach($salaries as $salary)
                                                        <option {{ ($job->salary == $salary->id) ? 'selected':'' }} value='{{$salary->id}}'>{{$salary->range}}</option>
                                                    @endforeach
                                                </select>
                                                @error('salary')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="job_location" class="form-control" required>
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option {{ ($job->job_location == $country->id) ? 'selected':'' }} value='{{$country->id}}'>{{$country->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('job_location')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="candidate_nationality" class="form-control" required>
                                                    ...
                                                    @foreach($nationalities as $nationality)
                                                        <option {{ ($job->candidate_nationality == $nationality->id) ? 'selected':'' }} value='{{$nationality->id}}'>{{$nationality->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="qualification" class="form-control" required>
                                                    ...
                                                    @foreach($qualifications as $qualification)
                                                        <option {{ ($job->qualification == $qualification->id) ? 'selected':'' }} value='{{$qualification->id}}'>{{$qualification->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('qualification')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="experience" class="form-control" required>
                                                    ...
                                                    @foreach($experiences as $experience)
                                                        <option {{ ($job->experience == $experience->id) ? 'selected':'' }} value='{{$experience->id}}'>{{$experience->year}}</option>
                                                    @endforeach
                                                </select>
                                                @error('experience')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="career_level" class="form-control" required>
                                                    ...
                                                    @foreach($careerLevels as $careerLevel)
                                                        <option {{ ($job->career_level == $careerLevel->id) ? 'selected':'' }} value='{{$careerLevel->id}}'>{{$careerLevel->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('career_level')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                        <input type="radio" name="type" {{$job->type == 1 ? 'checked' : ''}} value="1" required/>
                                                        <span></span>Full time</label>
                                                    <label class="radio" style="margin: auto">
                                                        <input type="radio" name="type" {{$job->type == 2 ? 'checked' : ''}} value="2" required/>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="skills[]" class="form-control js-example-basic-multiple" multiple="multiple" required>
                                                    @foreach($skills as $skill)
                                                        <option @foreach($jobSkills as $key => $value){{$value == $skill->id ? 'selected': ''}} @endforeach value='{{$skill->id}}'>{{$skill->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('skills')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="gender" class="form-control" required>
                                                    ...
                                                    <option {{$job->gender == 'Other' ? 'selected' : ''}} value="Other">Other</option>
                                                </select>
                                                @error('gender')
                                                <span class="invalid-feedback" role="alert">
                                                   {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="candidate_location" class="form-control" required>
                                                    ...
                                                    @foreach($candidateLocations as $candidateLocation)
                                                        <option {{ ($job->candidate_location == $candidateLocation->id) ? 'selected':'' }} value='{{$candidateLocation->id}}'>{{$candidateLocation->location}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category" class="form-control" required>
                                                    ...
                                                    @foreach($categories as $category)
                                                        <option {{ ($job->category == $category->id) ? 'selected':'' }} value='{{$category->id}}'>{{$category->category}}</option>
                                                    @endforeach
                                                </select>
                                                @error('category')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" name="date" value="{{$job->date}}" disabled id="example-date-input" />
                                                @error('date')
                                                <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                                </span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" name="endingDate" value="{{$job->endingDate}}" id="example-date-input"/>
                                                @error('endingDate')
                                                <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="card card-custom">
                                                ...
                                                <div class="card-body">
                                                    <textarea name="description" id="kt-ckeditor-1">{{$job->description}}</textarea>
                                                </div>
                                                @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="card card-custom">
                                                ...
                                                <div class="card-body">
                                                    <textarea name="responsibilities" id="kt-ckeditor-2">{{$job->responsibilities}}</textarea>
                                                </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="card card-custom">
                                                ...
                                                <div class="card-body">
                                                    <textarea name="education" id="kt-ckeditor-3">{{$job->education}}</textarea>
                                                </div>
                                                @error('education')
                                                <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
