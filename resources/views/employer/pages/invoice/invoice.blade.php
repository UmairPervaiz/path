            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Invoice Information</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="d-flex justify-content-between pt-6">
                                    <div class="d-flex flex-column flex-root">
                                        <span class="font-weight-bolder mb-2">DATE OF PURCHASE</span>
                            ...
                            <div class="col-md-9">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Package Type</th>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Buyer Name</th>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Buyer Email</th>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Buyer Phone No.</th>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Payment Method</th>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Payment Currency</th>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase" style="text-align: center">Amount paid</th>
                                        </tr>
                                        </thead>
                                        <tbody>
