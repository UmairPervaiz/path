...
<script src="{{asset('public/employer/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>

<!--begin::Page Scripts(used by this page)-->
<script src="{{asset('public/employer/dist/assets/js/pages/widgets.js')}}"></script>
...
<script src="{{asset('public/employer/dist/assets/plugins/custom/datatables/datatables.bundle.js')}}"></script>
