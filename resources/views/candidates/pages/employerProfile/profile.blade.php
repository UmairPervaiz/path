        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Employer's Profile</h5>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex justify-content-between flex-wrap mt-1">
                                            ...
                                            <div class="my-lg-0 my-3">
                                                <a href="{{url()->previous()}}" class="btn btn-sm btn-secondary font-weight-bolder text-uppercase">Back</a>
                                            </div>
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Content-->
                                            ...
                                            <div class="d-flex flex-column flex-grow-1 pr-8">
                                                <div class="d-flex flex-wrap mb-4">
                                                    ...
                                                    <a class="text-dark-50 text-hover-primary font-weight-bold">
                                                        <i class="flaticon2-placeholder mr-2 font-size-lg"></i>{{$employerLocation->name}}</a>
                                                </div>
                                ...
                                <div class="d-flex align-items-center flex-wrap mt-8">
                                    ...
                                    <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                                        ...
                                        <div class="d-flex flex-column text-dark-75">
                                            <span class="font-weight-bolder font-size-sm">Total Jobs Posted</span>
