    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card card-custom bg-info card-stretch gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <span class="font-weight-bold text-white font-size-sm">CV views</span>
                            </div>
                            <!--end::Body-->
                        </div>
                        <!--end::Stats Widget 30-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Number of Job(s) Applied
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <span class="d-flex align-items-center">
                                        ...
                                        @endif
                                    <span class="ml-3">
                                    <a href="{{route('jobDetail', encrypt($job->id))}}"><span class="text-dark-75 font-weight-bolder font-size-lg mb-0">{{$job->title}}</span></a><br>
                                    <a class="text-muted font-weight-bold text-hover-primary"> @foreach($jobSkills as $jobSkill) {{$jobSkill->name}} @endforeach</a>
                                        </span>
                                        </span>
                                        </span>
                                </td>
        ...
        <div class="container">
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Matched Job(s)
                            <span class="d-block text-muted pt-2 font-size-sm"></span></h3>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-separate table-head-custom table-checkable" id="myCustomTable1">
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;">Applied for</th>
                        </tr>
                        </thead>
                        <tbody>
                        @php $no = 0; @endphp
                        @foreach ($matchedJobs as $matchedJob)
                            @php
                                ...
                                @endphp
                            <tr>
                                <td style="text-align:center;"><a href="{{route('jobDetail', encrypt($matchedJob->id))}}"><span class="text-dark-75 font-weight-bolder font-size-lg mb-0">{{$matchedJob->title}}</span></a></td>
                                <td style="text-align:center;">{{$businessCategory->category}}</td>
                                <td style="text-align:center;">{{$location->name}}</td>
                                <td style="text-align:center;">
                                    @if(isset($applied))
                                        <span style="width: 158px;">
