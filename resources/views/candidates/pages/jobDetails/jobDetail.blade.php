            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Employer and Job Details</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                        ...
                        <div class="card card-custom card-stretch">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    <h3 class="card-label font-weight-bolder text-dark">Employer Information</h3>
                                </div>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            <div class="card-body pt-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        @endphp
                                        <div class="text-muted">@foreach($categories as $category) {{$category->category}} @if (!$loop->last) , @endif  @endforeach</div>
                                        <div class="mt-2">
                                        </div>
                                    </div>
                                </div>
...
{{--                                                                <span class="font-weight-bolder text-dark">78%</span>--}}
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
												...
												<span class="mr-4">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span class="font-weight-bolder font-size-sm">Job Location</span>
                                                        <span class="font-weight-bolder font-size-h5">
													   {{$jobLocation->name}}</span>
                                                    </div>
                                                </div>
                                                <!--end: Item-->
                                                <!--begin: Item-->
