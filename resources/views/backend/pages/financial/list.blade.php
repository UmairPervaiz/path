                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card card-custom bg-danger card-stretch gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                @php $countryName = DB::table('countries')->where('id', $topSellingCounty->country_name)->first(); @endphp
                                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">@if(isset($countryName)) {{$countryName->name}} @else N/A @endif</span>
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card card-custom bg-dark card-stretch gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                @php $topPurschasingUser = DB::table('users')->where('id', $topPurchasingEmployer->user_id)->first(); @endphp
                                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block" id="total-employers">@if(isset($topPurschasingUser)) {{$topPurschasingUser->name}} @else N/A @endif</span>
...
{{--          </div>--}}
            ...
            <div class="form-group row">
                <label class="col-form-label text-right col-lg-4 col-sm-12">Filter by Date</label>

                <div class="col-lg-4 col-md-9 col-sm-12">
                    <form method="GET" action="{{route('salesFilter')}}">
                        <div class="row">
                            <div class="col-md-9">
                                <input type="date" name="date" class="form-control" @if(isset($date)) value="{{$date}}" @endif required>
                            </div>
                            <div class="col-md-3">
            ...
            <div class="form-group row">
                <label class="col-form-label text-right col-lg-4 col-sm-12">Filter Sales by Month</label>
                <div class="col-lg-4 col-md-9 col-sm-12">
                    <form method="GET" action="{{route('salesFilter')}}">
                        <div class="row">
                            <div class="col-md-9">
                                <input type="month" name="month" class="form-control" @if(isset($month)) value="{{$month}}" @endif required>
                            </div>
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary btn-block">Filter</button>
                            </div>
            ...
            <div class="form-group row">
                ...
                <label class="col-form-label text-right col-lg-4 col-sm-12">Filter Sales by Year</label>
                @endif
                <div class="col-lg-4 col-md-9 col-sm-12">
                    @php
                        use Carbon\Carbon;
                    ...
                    @if($user->id == 1)
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="year" data-size="7" data-live-search="true" required>
                                    <option value="0">All</option>
                                    <option data-divider="true" label="Label"></option>
                                    @foreach( range($now,$from) as $i)
...
{{--                            <th style="text-align:center;">No. of applied candidate</th>--}}
                        ...
                        @foreach ($packages as $package)
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">{{$package->amount_paid}}</td>
                                <td style="text-align:center;">{{$package->customer_name}}</td>
                                <td style="text-align:center;">{{$package->customer_email}}</td>
...
@section('script')
    ...
    <script>
        $("#country").change(function (e) {
            $.ajax({
                url: "{{route('filterCountryFinancial')}}",
                method: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
        ...
        // Add data
        chart.data = <?php echo json_encode($sales, JSON_NUMERIC_CHECK); ?>;
