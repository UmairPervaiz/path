                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="start_date" value="{{old('start_date')}}" min="<?php echo date('Y-m-d') ?>" id="example-date-input" required/>
                                        @error('start_date')
                                        <span class="invalid-feedback" role="alert">
												{{ $message }}
										</span>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="end_date" value="{{old('end_date')}}" min="<?php echo date('Y-m-d') ?>" id="example-date-input" required/>
                                        @error('end_date')
                                        <span class="invalid-feedback" role="alert">
												{{ $message }}
										</span>
