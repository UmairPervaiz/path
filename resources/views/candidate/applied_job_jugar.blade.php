                ...
                <div class="dashboard-container">
                    <div class="dashboard-content-wrapper">
                        ...
                        <div class="dashboard-applied">
                            <h4 class="apply-title">0 Job Applied</h4>
...
{{--                                                    <h4><a href="#"></a></h4>--}}
{{--                                                    <div class="info">--}}
{{--                                                        <span class="company"><a href="#"><i data-feather="briefcase"></i></a></span>--}}
{{--                                                        <span class="office-location"><a href="#"><i data-feather="map-pin"></i></a></span>--}}
{{--                                                        <span class="job-type full-time"><a href="#"><i data-feather="clock"></i></a></span>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="more">--}}
{{--                                                    <div class="buttons">--}}
                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="dashboard-menu">
                            <ul>
                                ...
                                <li><i class="fas fa-heart"></i><a href="{{url('candidate/bookmarks', Auth::user()->id)}}">Bookmarked</a></li>
                                <li class="active"><i class="fas fa-check-square"></i><a href="{{url('candidate/applied_job', Auth::user()->id)}}">Applied Job</a></li>
