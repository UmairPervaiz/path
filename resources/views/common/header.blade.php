        ...
        <div class="row">
            <div class="col">
                <div class="header-top">
                    <div class="logo-area">
                        <a href="index.php"><img src="{{asset('images/logo-2.png')}}" alt=""></a>
                    </div>
                    ...
                    <div class="top-nav">
                            ...
                            <div class="account-card">
                                <div class="header-top-account-info">
                                    <a href="#" class="account-thumb">
                                        <img src="{{asset('images/account/thumb-1.jpg')}}" class="img-fluid" alt="">
                                    </a>
                        ...
                        <select class="selectpicker select-language" data-width="fit">
                            ...
                            <option  data-content='<span class="flag-icon flag-icon-sa"></span> عربي'>عربي</option>
                        </select>
                    </div>
                </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="menu-item dropdown">
                                ...
                                <ul  class="dropdown-menu">
                                    ...
                                    <li class="menu-item"><a  href="job-listing-with-map.php">Job Listing With Map</a></li>
                            ...
                            <li class="menu-item dropdown">
                                ...
                                <ul  class="dropdown-menu">
                                    <li class="menu-item"><a  href="candidate.php">Candidate Listing</a></li>
                            ...
                            <li class="menu-item dropdown">
                                ...
                                <ul  class="dropdown-menu">
                                    <li class="menu-item"><a  href="employer-listing.php">Employer Listing</a></li>
                                    <li class="menu-item"><a  href="employer-details.php">Employer Details</a></li>
                                ...
                                <ul  class="dropdown-menu">
                                    <li class="menu-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="menu-item"><a  href="dashboard-pricing.php">Pricing</a></li>
                                            <li class="menu-item"><a  href="dashboard-message.php">Message</a></li>
                                            <li class="menu-item"><a  href="dashboard-alert.php">Alert</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="menu-item"><a href="employer-dashboard-message.php">Dashboard Message</a></li>
                                            <li class="menu-item"><a href="employer-dashboard-pricing.php">Dashboard Pricing</a></li>
                            ...
                            <li class="menu-item dropdown">
                                ...
                                <ul  class="dropdown-menu">
                                    ...
                                    <li class="menu-item"><a href="pricing.php">Pricing Plan</a></li>
                                    ...
                                    <li class="menu-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="menu-item"><a href="blog-grid.php">News Grid</a></li>
                                            <li class="menu-item"><a href="blog-details.php">News Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item"><a href="checkout.php">Checkout</a></li>
                                    <li class="menu-item"><a href="payment-complete.php">Payment Complete</a></li>
                                    <li class="menu-item"><a href="invoice.php">Invoice</a></li>
