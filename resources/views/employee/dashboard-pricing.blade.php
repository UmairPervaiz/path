                            ...
                            <div class="col-md-6">
                                <div class="pricing starter">
                                    ...
                                    <div class="buy-button">
                                        <a href="checkout.php" class="button primary-bg">Get Started</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="dashboard-menu">
                            <ul>
                                ...
                                <li><i class="fas fa-briefcase"></i><a href="manage-job.php">Manage Jobs</a></li>
                                <li><i class="fas fa-users"></i><a href="manage-candidate.php">Manage Candidates</a></li>
                                <li><i class="fas fa-heart"></i><a href="manage-candidate.php">Shortlisted Resumes</a></li>
                                <li><i class="fas fa-plus-square"></i><a href="post-job.php">Post New Job</a></li>
                                {{--  <li><i class="fas fa-comment"></i><a href="message.php">Message</a></li>  --}}
                                <li class="active"><i class="fas fa-calculator"></i><a href="pricing.php">Pricing Plans</a></li>
                            </ul>
                            <ul class="delete">
