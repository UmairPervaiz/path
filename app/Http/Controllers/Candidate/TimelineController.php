...
//                    ->whereIn('job_location', [$candidateInfos->location])
//                    ->orWhereIn('job_location', $countryOfInterest)
//                    ->orWhereIn('category', $fieldOfExpertise)
//                    ->whereIn('gender', [$candidateInfos->gender])
//                    ->whereIn('experience', [3])
//                    ->whereIn('qualification', [$candidateInfos->qualification])
//                    ->where([
//                        ['status', '=', 1],
//                        ['approval_status', '=', 1]
//                    ])
...
//                    ->get();
    ...
    public function job_details($id)
    {
        ...
        DB::table('jobs')->where('id',decrypt($id))->increment('count', 1);
