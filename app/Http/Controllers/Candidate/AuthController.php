...
class AuthController extends Controller
{
    public function login(){
        ...
        return view('candidates.pages.auth.login');
    }
    ...
    public function candidateUpdateProfile(Request $request)
    {
        ...
        if($user == null)
        {
            return redirect()->route('candidateDashboard')->with('error', 'No Record Found.');
        }
        $rules = [
        ...
        return redirect()->route('candidateDashboard')->with('success', 'Updated Successfully');
