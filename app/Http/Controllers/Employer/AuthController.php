...
class AuthController extends Controller
{
    public function login(){
        ...
        return view('employer.pages.auth.login');
    }
    ...
    public function employerUpdateProfile(Request $request)
    {
        ...
        if($user == null)
        {
            return redirect()->route('employerDashboard')->with('error', 'No Record Found.');
        }
        $rules = [
        ...
        return redirect()->route('employerDashboard')->with('success', 'Updated Successfully');
