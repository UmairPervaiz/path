...
//                if (isset($request->experience_ending_date))
//                {
...
//                }
            ...
            if (count($fieldOfStudy) > 0 && count($interestCountry) > 0 ){
                ...
                $data['field_of_expertise'] = $request->field_of_expertise;
                $data['interestCountry'] = $request->country_of_interest;
            }
            ...
            $data['experience_ending_date'] = $request->experience_ending_date;
    ...
    public function store(Request $request)
    {
        ...
        $data1=array('role_id'=>'3',"model_type"=>'App\User',"model_id"=>$id);
...
//        }
        ...
        if ($request->input(['company']) != null && $request->input(['company_location']) != null && $request->input(['position']) != null &&
            $request->input(['experience_description']) != null && $request->input(['experience_starting_date']) != null && $request->input(['experience_ending_date']) != null )
        {
//            if (isset($request->experience_ending_date))
//            {
